...
function jl_wrap_triunsuitable(
        org_x::Cdouble,
        org_y::Cdouble,
        dest_x::Cdouble,
        dest_y::Cdouble,
...
function triangulate(
    ...
    if occursin("u", triangle_switches)
        c_wrap_triunsuitable = @cfunction(
            jl_wrap_triunsuitable,
            Cint,
            (Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble)
        )
        ccall(
            (:triunsuitable_callback, libtriangle),
            Cvoid,
            (Ptr{Cvoid},),
    ...
    # Call triangulate
    rc = ccall(
        (:triangulate_catch_exit, libtriangle),
        Cint,
