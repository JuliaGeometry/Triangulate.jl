...
function test()
    ...
    test1 = triout.trianglelist == [
        10 5 7 2 2 9 2 4 8 8 6 8 3;
    ...
    test3 = isapprox(
        triout.pointattributelist,
        [1.7 1.0 1.1 1.6 2.0 1.8 1.7 1.8 1.7 1.5 1.6 1.72149 1.55 1.42347 1.13548 1.50625];
        atol = 1.0e-5
    )

    test4 = triout.trianglelist == [
        13 5 7 2 12 9 14 9 16 2 3 12 6 8 9 14 5 7 1 15 3 8 14;
